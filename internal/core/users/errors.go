...
var EmployeeAlreadyAttached = errors.New("employee already attached to another organization")
var EmployeeNotAttached = errors.New("employee is not attached to manager's organization")
